...
function Layout(props: { children?: JSX.Element }) {
  ...
  onMount(() => {
    api.versionCheck().then((v) => setHasUpdate(v.hasUpdate)).catch(() => {});
  });
  ...
  return (
      <div class="app-main">
        <header class="topbar">
          ...
          <Show when={hasUpdate()}>
            <a class="topbar-update" href="https://github.com/louislam/dockge/releases" target="_blank" rel="noreferrer">
          ...
          <div class="avatar-menu">
            ...
            <Show when={menuOpen()}>
              <div class="avatar-dropdown">
                <div class="dd-user">{user()?.username}</div>
        ...
        <div class="dashboard-grid">
          ...
          <main class="content-col">{props.children}</main>
        </div>
        <ConfirmHost />
        <Toaster />
      </div>
